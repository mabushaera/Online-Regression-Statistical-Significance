"""
Synthetic Data Set Generator for DS2

This script generates and saves synthetic data sets (DS2) into CSV files. The generated data sets
...
Usage:
    Run this script to generate synthetic data sets (DS2) with varying random seeds and save them as CSV files.
...
Data Set Saving:
    ...
    - Each CSV file is named in the format "002_DS2_{seed}.csv", where {seed} corresponds to the random seed.
