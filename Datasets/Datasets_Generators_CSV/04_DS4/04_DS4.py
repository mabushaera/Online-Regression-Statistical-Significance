"""
Synthetic Data Set Generator for DS4

This script generates and saves synthetic data sets (DS4) into CSV files. The generated data sets
...
Usage:
    Run this script to generate synthetic data sets (DS4) with varying random seeds and save them as CSV files.
...
Data Set Saving:
    ...
    - Each CSV file is named in the format "004_DS4_{seed}.csv", where {seed} corresponds to the random seed.
...
path_to_save_data_set = Util.get_path_to_save_generated_dataset_file('04_DS4')
...
for seed in SEEDS:
    ...
    df.to_csv(path_to_save_data_set + '\\004_DS4_' + str(seed) + '.csv', index=False)
